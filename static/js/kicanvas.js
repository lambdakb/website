...
var P = (s, t, e, r) => {
  for (
    var i = r > 1 ? void 0 : r ? on(t, e) : t, n = s.length - 1, o;
    n >= 0;
    n--
  )
...
function hs(s) {
  return (
    s instanceof URL && (s = s.pathname), s.split('/').slice(0, -1).join('/')
  )
}
l(hs, 'dirname')
function Xe(s) {
...
function Gt(s) {
  let t, e
  s instanceof File
    ? ((t = URL.createObjectURL(s)), (e = s.name))
    : ((t = s.href), (e = Xe(t)))
  ...
  Ne = class {
    ...
    get stylesheet() {
      ...
      return (
        t == null &&
          ((t = new CSSStyleSheet()),
          t.replaceSync(this.css_string),
          Ms.set(this.css_string, t)),
        t
      )
    }
  }
...
l(T, 'css')
function fs(s, t) {
  s.adoptedStyleSheets = s.adoptedStyleSheets.concat(
    t.map((e) => (e instanceof CSSStyleSheet ? e : e.stylesheet)),
  )
}
l(fs, 'adopt_styles')
function G2(s) {
...
function un(s, t) {
  ...
  for (let i = 0; i < s.length - 1; i++)
    e.push(s[i]), t[i] instanceof j3 ? e.push(t[i].text) : e.push(`$$:${i}:$$`)
    ...
    for (let i = 0; i < r.length; i++) {
      ...
      if (n)
        if (i % 2 == 0) s.insertBefore(new Text(n), t)
          ...
          for (let o of Vs(e[parseInt(n, 10)]))
            o != null && s.insertBefore(o, t)
    }
    t.data = ''
  }
}
...
function dn(s, t, e) {
  ...
  if (!(!r || r.length == 1)) {
    if (t.localName.startsWith('on'))
      throw new Error(`Cannot bind to event handler ${t.localName}.`)
...
var Oe = class extends HTMLElement {
  constructor() {
    ...
    e.exportparts.length &&
      this.setAttribute('exportparts', e.exportparts.join(','))
  }
  static {
  ...
  renderedCallback() {}
  async update() {
    for (this.updateComplete = new Me(); this.renderRoot.firstChild; )
  ...
  queryAssignedElements(e, r) {
    let n =
      this.renderRoot
        .querySelector(`slot${e ? `[name=${e}]` : ':not([name])'}`)
        ?.assignedElements() ?? []
...
var gs = {
  to_attribute(s, t) {
    ...
    switch (t) {
      ...
      default:
        throw new Error(
          `Can not convert type "${t}" and value "${s} to attribute`,
        )
    }
  },
  from_attribute(s, t) {
...
var de = class extends N {
  ...
  render() {
    let e = this.icon
      ? _`<kc-ui-icon part="icon">${this.icon}</kc-ui-icon>`
      : void 0
...
var ot = class extends N {
  ...
  get #r() {
    return Array.from(this.#t).map((e) =>
...
var E2 = class extends N {
  ...
  set selected(t) {
    ...
    G(t) ? (e = this.item_by_name(t)) : (e = t),
      this.deselect(),
      !(!e || !(e instanceof Ue)) &&
        ((e.selected = !0), this.send_selected_event(e))
  }
  ...
  initialContentCallback() {
    super.initialContentCallback(),
      he(this, 'kc-ui-menu-item', 'click', (t, e) => {
        t.target.tagName != 'KC-UI-BUTTON' &&
          (t.stopPropagation(), (this.selected = e))
      })
  }
  render() {
    return _`<slot></slot>`
...
var It = class extends N {
  ...
  show() {
    this.visible ||
      ((this.visible = !0),
      this.dispatchEvent(
        new CustomEvent('kc-ui-dropdown:show', { bubbles: !0, composed: !0 }),
      ))
  }
  hide() {
    this.visible &&
      ((this.visible = !1),
      this.dispatchEvent(
        new CustomEvent('kc-ui-dropdown:hide', { bubbles: !0, composed: !0 }),
      ))
  }
  toggle() {
...
P([L({ type: Boolean })], It.prototype, 'visible', 2),
  P([L({ type: Number })], It.prototype, 'mouseout_padding', 2)
...
var sr = class extends N {
  ...
  *items() {
    for (let t of this.queryAssignedElements())
      yield* t.querySelectorAll(this.item_selector)
  }
  apply_filter() {
    ue(() => {
...
var or = class extends N {
  ...
  initialContentCallback() {
    this.addEventListener('click', () => {
      ...
      this.addDisposable(
        k(document, 'click', (t) => {
          !t.composedPath().includes(this.parentElement) &&
            this.classList.remove('has-focus')
        }),
      ),
      (this.#e = new IntersectionObserver((t) => {
        for (let e of t)
          console.log(e), e.isIntersecting || this.classList.remove('has-focus')
      })),
      this.#e.observe(this),
      this.addDisposable({
        dispose: () => {
  ...
  initialContentCallback() {
    ;(this.input.disabled = this.disabled),
      this.input.addEventListener('input', (e) => {
        e.stopPropagation(),
          this.dispatchEvent(
            new CustomEvent('kc-ui-range:input', { composed: !0, bubbles: !0 }),
          )
      })
  }
  render() {
  ...
  initialContentCallback() {
    ...
    this.addEventListener('mousedown', (r) => {
      ...
      ;(document.body.style.cursor = 'col-resize'),
        ...
        e.hasAttribute('collapsed') &&
          (console.log('removing collapsed'), e.removeAttribute('collapsed'))
      let o = l((p) => {
          let m = i - p.clientX,
            b =
              ((n + m) * 100) / this.parentElement.getBoundingClientRect().width
          e.style.width = `${b}%`
        }, 'mouse_move'),
...
P([Q('input', !0)], kt.prototype, 'input', 2),
  P([Q('button', !0)], kt.prototype, 'button', 2)
...
P([L({ type: String })], At.prototype, 'icon', 2),
  P([L({ type: Boolean })], At.prototype, 'visible', 2)
...
var d = class s {
  ...
  *[Symbol.iterator]() {
  ...
  multiply(t) {
    return le(t)
      ? new s(this.x * t, this.y * t)
      : new s(this.x * t.x, this.y * t.y)
  }
  resize(t) {
...
var O = class s {
  constructor(t = 0, e = 0, r = 0, i = 0, n) {
    ...
    this.h = i
    this.context = n
    this.w < 0 && ((this.w *= -1), (this.x -= this.w)),
      this.h < 0 && ((this.h *= -1), (this.y -= this.h))
  }
  static {
    l(this, 'BBox')
  }
  ...
  get valid() {
    return (
      (this.w !== 0 || this.h !== 0) && this.w !== void 0 && this.h !== void 0
    )
  }
  get start() {
  ...
  scale(t) {
    return s.from_points(
      [this.start.multiply(t), this.end.multiply(t)],
      this.context,
    )
  }
  mirror_vertical() {
...
var z = class s {
  ...
  static from_three_points(t, e, r, i = 1) {
    let o = Mn(
      new d(t.x * 1e6, t.y * 1e6),
      new d(e.x * 1e6, e.y * 1e6),
      new d(r.x * 1e6, r.y * 1e6),
    )
    ;(o.x /= 1e6), (o.y /= 1e6)
  ...
  static from_center_start_end(t, e, r, i) {
    ...
    return (
      ...
      u.degrees > p.degrees &&
        (p.degrees < 0
          ? (p = p.normalize())
          : (u = u.normalize().sub(W.from_degrees(-360)))),
      new s(t, n, u, p, i)
    )
  }
  get start_radial() {
  ...
  to_polyline() {
    ...
    for (let n = e; n < r; n += Math.PI / 32)
      t.push(
        new d(
          this.center.x + Math.cos(n) * this.radius,
          this.center.y + Math.sin(n) * this.radius,
        ),
      )
    let i = new d(
      this.center.x + Math.cos(r) * this.radius,
      this.center.y + Math.sin(r) * this.radius,
    )
...
function Mn(s, t, e) {
  let r = Math.SQRT1_2,
    ...
    u = e.x - t.x
  if ((o == 0 && c == 0) || (n == 0 && u == 0))
    return (i.x = (s.x + e.x) / 2), (i.y = (s.y + e.y) / 2), i
  ...
  let f = p * m * (s.y - e.y),
    ...
    S = m * (s.x + t.x),
    y =
      S * Math.sqrt(((M / m) * M) / m + ((r / (s.x + t.x)) * r) / (s.x + t.x)),
    v = p * (t.x + e.x),
    te =
      v * Math.sqrt(((b / p) * b) / p + ((r / (t.x + e.x)) * r) / (t.x + e.x)),
    X = 2 * (m - p),
...
var h = class s {
  ...
  static from_css(t) {
    ...
    if (t[0] == '#')
      ...
      t.startsWith('rgba') || (t = `rgba(${t.slice(4, -1)}, 1)`),
        (t = t.trim().slice(5, -1))
      let o = t.split(',')
...
Context: ${$t(s, o)}`)
      ...
      if (mr(c)) continue
      if (c === ')' || k2(c))
        yield new E(E.ATOM, s.substring(i, o)), (r = 0), c === ')' && (yield e)
      else
...
Context: ${$t(s, o)}`)
      ...
      if (c.toLowerCase() === 'x') {
        ...
        yield new E(E.NUMBER, parseFloat(s.substring(i, o))),
          (r = 0),
          c === ')' && (yield e)
        continue
      } else
...
Context: ${$t(s, o)}`)
      ...
      if (c === ')' || k2(c)) {
        ...
        yield new E(E.NUMBER, Number.parseInt(u, 16)),
          (r = 0),
          c === ')' && (yield e)
        continue
      } else if (mr(c)) {
  ...
  a = {
    ...
    list(s, t = R.any) {
      return {
        ...
        name: s,
        accepts: [s],
        fn: (e, r, i) => i.slice(1).map((n) => t(e, r, n)),
      }
    },
...
function g(s, ...t) {
  ...
  if (r) {
    let o = G2(r.name),
      c = s.at(0)
    if (!o.includes(c))
      throw new Error(`Expression must start with ${r.name} found ${c} in ${s}`)
    s = s.slice(1)
  }
  let n = {}
  i = 0
  for (let o of s) {
    ...
    if ((G(o) && (c = e.get(o)), !c && (G(o) || le(o)))) {
      if (((c = e.get(i)), !c)) {
        br.warn(
          `no def for bare element ${o} at position ${i} in expression ${s}`,
        )
        continue
      }
      i++
...
var H = class s {
  ...
  J = class s {
    ...
    copy() {
      let t = new s()
      return (
        (t.font = this.font.copy()),
        (t.justify = this.justify.copy()),
        (t.hide = this.hide),
        t
      )
    }
...
var ge = class {
    ...
    *items() {
    ...
    get edge_cuts_bbox() {
      let t = new O(0, 0, 0, 0)
      for (let e of this.drawings)
        e.layer != 'Edge.Cuts' ||
          !(e instanceof Qe) ||
          (t = O.combine([t, e.bbox]))
      return t
    }
    find_footprint(t) {
      for (let e of this.footprints)
        if (e.uuid == t || e.reference == t) return e
      return null
    }
  },
  Mr = class {
      ...
      Object.assign(
        ...
        g(
          ...
          a.object(
            'hatch',
            {},
            a.positional('style', R.string),
            a.positional('pitch', R.number),
          ),
  ...
  xe = class {
    constructor(t, e) {
      ...
      for (let r of this.drawings)
        r instanceof Ce &&
          (r.type == 'reference' && (this.reference = r.text),
    ...
    *items() {
    ...
    resolve_text_var(t) {
      ...
      return this.properties[t] !== void 0
        ? this.properties[t]
        : this.parent.resolve_text_var(t)
    }
    pad_by_number(t) {
      return this.#e.get(t)
    }
    get bbox() {
      if (!this.#t) {
        ...
        for (let r of this.drawings)
          r instanceof Ce || (t = O.combine([t, r.bbox.transform(e)]))
    ...
    constructor(t) {
      Object.assign(
        ...
        g(
          t,
          a.start('options'),
          a.pair('clearance', R.string),
          a.pair('anchor', R.string),
        ),
      )
    }
  },
...
var A = {
  ...
  me = class {
    ...
    *items() {
    ...
    find_symbol(t) {
      ...
      for (let e of this.symbols.values())
        if (e.uuid == t || e.reference == t) return e
      return null
    }
    find_sheet(t) {
  ...
  e3 = class {
    ...
    constructor(t) {
      Object.assign(
        this,
        g(t, a.start('fill'), a.pair('type', R.string), a.color()),
      )
    }
  },
  ee = class {
  ...
  xr = class {
    constructor(t) {
      ...
      Object.assign(
        this,
        g(t, a.start('bus_alias'), a.list('members', R.string)),
      )
    }
    static {
      l(this, 'BusAlias')
  ...
  u2 = class {
    ...
    constructor(t) {
      Object.assign(
        this,
        g(t, a.start('no_connect'), a.item('at', H), a.pair('uuid', R.string)),
      )
    }
  },
  _t = class extends ee {
    constructor(e, r) {
      ...
      if (i.radius?.length) {
        ...
        n.arc_angle.degrees > 180 &&
          ([n.start_angle, n.end_angle] = [n.end_angle, n.start_angle]),
  ...
  Qr = class extends ee {
    constructor(e, r) {
      ...
      Object.assign(
        this,
        g(e, a.start('bezier'), a.list('pts', R.vec2), ...ee.common_expr_defs),
      )
    }
    static {
      l(this, 'Bezier')
...
`) && (this.text = this.text.slice(0, this.text.length - 1))
  ...
  d2 = class extends ve {
    ...
    constructor(t) {
      super(),
        Object.assign(this, g(t, a.start('label'), ...ve.common_expr_defs))
    }
  },
  m2 = class extends ve {
    constructor(e) {
    ...
    constructor(t, e) {
      ...
      Object.assign(
        ...
        g(
          t,
          a.start('lib_symbols'),
          a.collection('symbols', 'symbol', R.item(Vt, e)),
        ),
      )
  ...
  Vt = class s {
    ...
    pin_by_number(t, e = 1) {
      ...
      for (let r of this.children)
        if ((r.style == 0 || r.style == e) && r.has_pin(t))
          return r.pin_by_number(t)
    ...
    property_by_id(t) {
      ...
      for (let e of this.children)
        if (e.has_property_with_id(t)) return e.property_by_id(t)
      return null
    }
    get library_name() {
  ...
  re = class {
    constructor(t, e) {
      ...
      this.get_property_text('Value') == null &&
    ...
    get unit_pins() {
      return this.pins.filter(
        (t) => !(this.unit && t.unit && this.unit != t.unit),
      )
    }
    resolve_text_var(t) {
...
var _2 = class s {
  ...
  We = class {
    constructor(t) {
      ...
      ;(this.position.x = e.x),
        (this.position.y = e.y),
        (this.anchor = e.anchor ?? this.anchor)
    }
    static {
      l(this, 'Coordinate')
    }
...
function $r(s, t) {
  if (!(t == null || t == null))
    for (let e of Object.keys(t)) _s(s[e]) ? $r(s[e], t[e]) : (s[e] = t[e])
}
l($r, 'merge')
var Be = class s {
    constructor() {
...
var s3 = new ce('kicanvas:project'),
  Wt = class extends EventTarget {
      ...
      for (await Promise.all(r); r.length; ) {
        ...
        for (let i of this.schematics())
          for (let n of i.sheets)
            !this.#t.get(n.sheetfile ?? '') &&
              n.sheetfile &&
              r.push(this.#s(n.sheetfile))
        await Promise.all(r)
      }
      this.#c(),
        this.loaded.open(),
    ...
    async #s(e) {
      if ((s3.info(`Loading file ${e}`), e.endsWith('.kicad_sch')))
        return await this.#n(me, e)
        ...
        for (let p of u.sheets)
          if (this.#t.get(p.sheetfile ?? ''))
            for (let b of p.instances.values())
              e.set(b.path, u),
                r.set(`${b.path}/${p.uuid}`, { sheet: p, instance: b })
      }
    ...
    *pages() {
    ...
    async download(e) {
      return (
        this.#r.has(e) && (e = this.#r.get(e).filename),
        await this.#e.download(e)
      )
    }
    #a
    get active_page() {
...
var n3 = class extends Error {
  ...
  $e = class s {
    ...
    async request(t, e, r) {
      ...
      return (
        ...
        (this.rate_limit_remaining = parseInt(
          c.headers.get('x-ratelimit-remaining') ?? '',
          10,
        )),
        c.headers.get('content-type') == 'application/json; charset=utf-8'
          ? await c.json()
          : await c.text()
      )
    }
    ...
    async repos_contents(t, e, r, i) {
      return await this.request(`repos/${t}/${e}/contents/${r}`, {
        ref: i ?? '',
      })
    }
  },
  o3 = class s {
    ...
    convert_url(t) {
      ...
      if (r.length < 4)
        throw new Error(
          `URL ${t} can't be converted to a raw.githubusercontent.com URL`,
        )
      let [i, n, o, c, u, ...p] = r
      if (c != 'blob')
        throw new Error(
  ...
  N2 = class s extends it {
    ...
    static async fromURLs(...e) {
      ...
      for (let i of e) {
        ...
        if (!(!n || !n.owner || !n.repo)) {
          if (
            (n.type == 'root' && ((n.ref = 'HEAD'), (n.type = 'tree')),
            n.type == 'blob')
          )
    ...
    initialContentCallback() {
      this.renderRoot.addEventListener('input', (e) => {
        ...
        r.name === 'theme' && (g2.theme = Ze.by_name(this.theme_control.value)),
          r.name === 'align-controls-kicad' &&
            (g2.alignControlsWithKiCad = r.checked),
          g2.save()
      })
    }
    render() {
...
var Se = class extends N {
  ...
  async load(e) {
    await this.viewerReady,
      this.can_load(e)
        ? (await this.#e.load(e), (this.hidden = !1))
        : (this.hidden = !0)
  }
  #r() {
  ...
  render() {
    let e = this.controls ?? 'none',
      r = ws(
        this.controlslist ?? '',
        e == 'none'
          ? { fullscreen: !1, download: !1 }
          : { fullscreen: !0, download: !0 },
      )
    ;(this.#e = this.make_viewer_element()),
      (this.#e.disableinteraction = e == 'none')
    let i = null
    if (e == 'full') {
    ...
    return (
      e != 'none' &&
        (c = _`<kc-viewer-bottom-toolbar></kc-viewer-bottom-toolbar>`),
...
var B = class {
  ...
  F = class s {
    ...
    static from_BBox(t, e, r) {
      return new s(
        [t.top_left, t.top_right, t.bottom_right, t.bottom_left, t.top_left],
        e,
        r,
      )
    }
...
var Ke = class {
    ...
    prep_circle(t, e, r) {
      ...
      t instanceof B ? (i = t) : (i = new B(t, e, r ?? this.state.fill)),
        (!i.color || i.color.is_transparent_black) &&
          (i.color = this.state.fill ?? h.transparent_black),
    ...
    prep_arc(t, e, r, i, n, o) {
      ...
      t instanceof Ye
        ...
        (!c.color || c.color.is_transparent_black) &&
          (c.color = this.state.stroke ?? h.transparent_black)
      let p = new z(
        c.center,
        c.radius,
        c.start_angle,
    ...
    prep_line(t, e, r) {
      ...
      t instanceof F
        ? (i = t)
        : (i = new F(t, e ?? this.state.stroke_width, r ?? this.state.stroke)),
        (!i.color || i.color.is_transparent_black) &&
          (i.color = this.state.stroke ?? h.transparent_black),
    ...
    prep_polygon(t, e) {
      ...
      return (
        ...
        (!r.color || r.color.is_transparent_black) &&
          (r.color = this.state.fill ?? h.transparent_black),
...
function Es(s, t, e, r, i) {
  var n, o
  if (i === Ri(s, t, e, r) > 0)
    for (n = t; n < e; n += r) o = Gs(n, s[n], s[n + 1], o)
...
function je(s, t) {
  ...
  do
    if (
      ((r = !1), !e.steiner && (h3(e, e.next) || w(e.prev, e, e.next) === 0))
    ) {
...
function vn(s, t) {
  ...
  do {
    if (i <= e.y && i >= e.next.y && e.next.y !== e.y) {
      ...
      if (
        c <= r &&
        c > n &&
        ((n = c), (o = e.x < e.next.x ? e : e.next), c === r)
      )
        return o
    }
    e = e.next
  ...
  do
    r >= e.x &&
      ...
      Z2(e, s) &&
        (M < b || (M === b && (e.x > o.x || (e.x === o.x && wn(o, e))))) &&
        ((o = e), (b = M))),
      (e = e.next)
  while (e !== u)
  return o
...
function Gn(s, t) {
  return (
    ...
    ((Z2(s, t) &&
      Z2(t, s) &&
      Jn(s, t) &&
      (w(s.prev, s, t.prev) || w(s, t.prev, t))) ||
...
function Ri(s, t, e, r) {
  for (var i = 0, n = t, o = e - r; n < e; n += r)
    (i += (s[o] - s[n]) * (s[n + 1] + s[o + 1])), (o = n)
  return i
}
l(Ri, 'signedArea')
T2.flatten = function (s) {
  for (
    ...
    for (var n = 0; n < s[i].length; n++)
      for (var o = 0; o < t; o++) e.vertices.push(s[i][n][o])
...
var ui = class {
  ...
  Tt = class s {
    ...
    static link(t, e, r) {
      ...
      throw (
        (t.deleteProgram(i), new Error(`Error linking shader program: ${n}`))
      )
    }
    #t() {
      this.uniforms = {}
      for (
        let t = 0;
        t < this.gl.getProgramParameter(this.program, this.gl.ACTIVE_UNIFORMS);
        t++
      ) {
        let e = this.gl.getActiveUniform(this.program, t)
        if (e == null)
          throw new Error(
            `Could not get uniform info for uniform number ${t} for program ${this.program}`,
          )
        ...
        this[e.name] = this.uniforms[e.name] = new ui(
          this.gl,
          e.name,
          r,
          e.type,
    ...
    #r() {
      ...
      for (
        let t = 0;
        t <
        this.gl.getProgramParameter(this.program, this.gl.ACTIVE_ATTRIBUTES);
        t++
      ) {
        ...
        ;(this.attribs[e.name] = e),
          (this[e.name] = this.gl.getAttribLocation(this.program, e.name))
      }
    }
    bind() {
  ...
  pi = class {
    ...
    set(t, e) {
      this.bind(),
        (e ??= this.gl.STATIC_DRAW),
        this.gl.bufferData(this.target, t, e)
    }
    get length() {
      return (
        this.bind(),
...
var ze = class {
    ...
    static quad_to_triangles(t) {
      ...
      if (e.filter((r) => Number.isNaN(r)).length)
    ...
    static tesselate_polyline(t) {
      ...
      return {
        position_array: c.slice(0, m * 2),
        cap_array: p.slice(0, m),
        color_array: u.slice(0, m * 4),
      }
    }
    ...
    static triangulate_polygon(t) {
      ...
      if (e.length == 3)
        return (t.points = []), (t.vertices = new Float32Array(r)), t
      let i = T2(r),
  ...
  m3 = class s {
    ...
    set(t) {
      if (!t.length) return
      let e = t.reduce(
          (p, m) => p + (m.points.length - 1) * ze.vertices_per_quad,
          0,
        ),
        r = new Float32Array(e * 2),
        i = new Float32Array(e),
  ...
  L2 = class {
    ...
    commit() {
      this.#e.length &&
        ((this.#i = new b3(this.gl)), this.#i.set(this.#e), (this.#e = void 0)),
        this.#r.length &&
          ((this.#n = new m3(this.gl)),
          this.#n.set(this.#r),
          (this.#r = void 0)),
        this.#t.length &&
          ((this.#s = new d3(this.gl)),
          this.#s.set(this.#t),
          (this.#t = void 0))
    }
    render(t, e = 0, r = 1) {
...
var _3 = class extends Ke {
  ...
  mi = class extends He {
    ...
    render(e, r, i = 1) {
      ...
      this.composite_operation != 'source-over' &&
        n.blendFunc(n.ONE_MINUS_DST_COLOR, n.ONE_MINUS_SRC_ALPHA),
  ...
  for (let n = 0; n < s.length + 1; n++) {
    ...
    switch (o) {
      ...
      case '{':
        r &&
          (i++,
          yield { text: s.slice(e, n - 1) },
          yield { open: i, control: r },
          (r = null),
          (e = n + 1))
        break
      case '}':
        i &&
          (yield { text: s.slice(e, n) }, yield { close: i }, (e = n + 1), i--)
        break
      case t:
...
var yt = class {
    ...
    get_line_extents(t, e, r, i, n) {
      let o = new Ge()
      ;(o.bold = i), (o.italic = n)
      let { bbox: c } = this.get_markup_as_glyphs(
        t,
        new d(0, 0),
        e,
        new W(0),
...
`)
    ...
    draw_line(t, e, r, i, n) {
      ...
      let { glyphs: c, bbox: u } = this.get_markup_as_glyphs(
          e,
          r,
          n.size,
          n.angle,
    ...
    get_line_bbox(t, e, r, i) {
      let n = new Ge()
      n.italic = i
      let { bbox: o, next_position: c } = this.get_markup_as_glyphs(
        t,
        e,
        r,
        new W(0),
...
`),
      ...
      let b = []
      for (let M = 0; M < c; M++)
        b.push({ text: o[M], position: n[M], extents: i[M] })
      return b
    }
    ...
    get_markup_node_as_glyphs(t, e, r, i, n, o, c) {
      ...
      if (
        ...
        let {
          ...
          cursor: f,
          bbox: V,
        } = this.get_text_as_glyphs(t.text, r, e, i, n, o, b)
      ...
      for (let M of t.children) {
        let {
          ...
          bbox: V,
          glyphs: S,
        } = this.get_markup_node_as_glyphs(M, m, r, i, n, o, b)
    ...
    wordbreak_markup_node(t, e, r) {
      ...
      for (let o of t.children)
        n = n.concat(this.wordbreak_markup_node(o, e, r))
      return n
    }
  },
  Ge = class s {
...
var Y = class s extends yt {
  ...
  get_text_as_glyphs(t, e, r, i, n, o, c) {
    ...
    ;(c.subscript || c.superscript) &&
      ((y = y.multiply(0.7)),
      c.subscript ? (S.y += y.y * 0.3) : (S.y -= y.y * 0.5))
    for (let ye of t)
      switch (ye) {
        case '	':
          {
        ...
        default:
          {
            ...
            V.push(C.transform(y, S, v, i, n, o)),
              v && (se.x -= se.y * v),
              (S.x += Math.round(se.x))
          }
          break
    ...
    if (
      (c.overbar
        ...
        : c.underline &&
          ((te = !0), (X.y = this.compute_underline_vertical_position(y.y))),
      te)
    ) {
    ...
    return (
      (rt.start = r),
      (rt.end = new d(
        S.x + X.x - Math.round(y.x * 0.2),
        S.y + Math.max(y.y, X.y * s.overbar_position_factor),
      )),
...
function $s(s) {
  ...
  for (let m = 0; m < s.length; m += 2) {
    ...
    if (m < 2) (t = M[0] * Y.font_scale), (e = M[1] * Y.font_scale), (r = e - t)
      ...
      let f = new d(
        M[0] * Y.font_scale - t,
        (M[1] + Y.font_offset) * Y.font_scale,
      )
      c == null && ((c = []), o.push(c)),
        (i = Math.min(i, f.y)),
        (n = Math.max(n, f.y)),
...
var $ = class {
  ...
  apply_at(t) {
    ;(this.text_pos = t.position.multiply(1e4)),
      (this.text_angle = W.from_degrees(t.rotation))
  }
  get shown_text() {
    return this.text
  }
  get_effective_text_thickness(t) {
    ...
    return (
      e < 1 &&
        ((e = t ?? 0),
        this.bold
          ? (e = jn(this.text_width))
          : e <= 1 && (e = zn(this.text_width))),
...
`)),
    ...
    if (
      (this.multiline &&
        t &&
        t < n.length &&
        (r.y -= Math.round(t * u.get_interline(p.y))),
      o.includes('~{') && (f = M.y / 14),
      e && (r.y = -r.y),
      (i.start = r),
      this.multiline && !t && n.length)
    ) {
      for (let y of n.slice(1))
        (M = u.get_line_extents(y, p, c, m, b)), (V.x = Math.max(V.x, M.x))
...
var g3 = class extends $ {
  ...
  normalize_justification(t) {
    ...
    this.text_angle.is_horizontal
      ? (this.h_align == 'left'
          ? (e.x = r.w / 2)
          : this.h_align == 'right' && (e.x = -(r.w / 2)),
        this.v_align == 'top'
          ? (e.y = -(r.h / 2))
          : this.v_align == 'bottom' && (e.y = r.h / 2))
      : (this.h_align == 'left'
          ? (e.y = r.w / 2)
          : this.h_align == 'right' && (e.y = -(r.w / 2)),
        this.v_align == 'top'
          ? (e.x = r.h / 2)
          : this.v_align == 'bottom' && (e.x = -(r.h / 2))),
      t && (e = e.multiply(-1)),
...
var P3 = class extends $ {
  ...
  get draw_rotation() {
    ...
    return (
      Math.abs(r.elements[1]) == 1 && (e == 0 || e == 180 ? (e = 90) : (e = 0)),
      W.from_degrees(e)
    )
  }
  get position() {
    if (this.parent) {
      ...
      return (
        (e = this.parent.transform.transform(e)), e.add(this.parent.position)
      )
    }
  ...
  get bounding_box() {
    ...
    return (
      (e.start = c.transform(n)),
      (e.end = c.transform(o)),
      (e.start = e.start.add(r)),
      e
    )
  }
}
  ...
  Ut = class {
    ...
    *query(t) {
    ...
    highlight(t) {
      ...
      for (let r of this.#e)
        e.includes(r.name) ? (r.highlighted = !0) : (r.highlighted = !1)
    }
    ...
    *query_point(t) {
      for (let e of this.interactive_layers())
        for (let r of e.query_point(t)) yield { layer: e, bbox: r }
    }
    *query_item_bboxes(t) {
      for (let e of this.interactive_layers()) {
  ...
  Ee = class {
    ...
    paint(t) {
      ...
      for (let e of this.paintable_layers())
        O2.debug(`Painting layer ${e.name} with ${e.items.length} items`),
          this.paint_layer(e)
  ...
  Mi = class extends be {
    ...
    paint(e, r) {
      ...
      ;(i.attributes.bold = r.font?.bold ?? !1),
        ...
        (i.attributes.size = (r.font?.size ?? r.parent.setup.textsize).multiply(
          1e4,
        )),
        (i.attributes.stroke_width =
          (r.font?.linewidth ?? r.parent.setup.textlinewidth) * 1e4)
  ...
  T3 = class {
    ...
    update() {
      ...
      for (let c = r; c <= i; c += 1)
        for (let u = n; u <= o; u += 1) {
          let p = new d(
            c * t.spacing + this.origin.x,
            u * t.spacing + this.origin.y,
          )
      ...
      if (this.origin.x != 0 && this.origin.y != 0) {
        ...
        let c = new d(1.5, 1.5)
        this.gfx.line(
          [this.origin.sub(c), this.origin.add(c)],
          t.radius / 2,
          this.origin_color,
        ),
          (c = new d(-1.5, 1.5)),
  ...
  y3 = class {
    constructor(t, e, r, i = 0.5, n = 10, o) {
      ...
      this.target.addEventListener('touchstart', (b) => {
        b.touches.length === 2
          ? (c = this.#t(b.touches))
          : b.touches.length === 1 && (u = b.touches)
      }),
      ...
      this.target.addEventListener('mousedown', (b) => {
        ;(b.button === 1 || b.button === 2) &&
          (b.preventDefault(), (m = !0), (p = new d(b.clientX, b.clientY)))
      }),
      ...
      en.alignControlsWithKiCad
        ...
        en.alignControlsWithKiCad
          ? t.shiftKey || t.ctrlKey
            ? this.#s(-e, r)
            : ((this.#e = this.target.getBoundingClientRect()),
              this.#n(r, this.#i(t)))
          : t.ctrlKey
            ? ((this.#e = this.target.getBoundingClientRect()),
              this.#n(r, this.#i(t)))
        ...
        this.target.dispatchEvent(
          new MouseEvent('panzoom', { clientX: t.clientX, clientY: t.clientY }),
        )
    }
    #i(t) {
...
var F2 = class extends EventTarget {
  ...
  on_mouse_change(e) {
    let r = this.canvas.getBoundingClientRect(),
      i = this.viewport.camera.screen_to_world(
        new d(e.clientX - r.left, e.clientY - r.top),
      )
    ;(this.mouse_position.x != i.x || this.mouse_position.y != i.y) &&
      (this.mouse_position.set(i),
      this.dispatchEvent(new Zt(this.mouse_position)))
  }
  resolve_loaded(e) {
  ...
  on_draw() {
    ...
    for (let n of this.layers.in_display_order())
      if (n.visible && n.graphics) {
        let o = n.opacity
        i && !n.highlighted && (o = 0.25),
          n.graphics.render(r, e, o),
          (e += 0.01)
      }
  }
  draw() {
  ...
  _set_selected(e) {
    ...
    ;(this.#e = e?.copy() || null),
      this.dispatchEvent(
        new D({ item: this.#e?.context, previous: r?.context }),
      ),
  ...
  zoom_to_selection() {
    this.selected &&
      ((this.viewport.camera.bbox = this.selected.grow(10)), this.draw())
  }
}
  ...
  Ft = class extends F2 {
    ...
    paint() {
      this.document &&
        ...
        new W3(this.renderer, this.layers, this.theme).paint(
          this.drawing_sheet,
        ),
    ...
    select(e) {
      if (e != null && !(e instanceof O))
        throw new Error(
          `Unable to select item ${e}, could not find an object that matched.`,
        )
  ...
  constructor(e, r) {
    ...
    for (let n of Object.values(et)) {
      ...
      let o = !0,
        c = !1
      to.includes(n) &&
        ((o = l(() => this.is_any_copper_layer_visible(), 'visible')),
        (c = !0)),
        n == ':Pads:Front' &&
          ((o = l(() => this.by_name('F.Cu').visible, 'visible')), (c = !0)),
        n == ':Pads:Back' &&
          ((o = l(() => this.by_name('B.Cu').visible, 'visible')), (c = !0)),
        io(n) &&
          ((c = !0),
          this.add(
            new ae(
...
var j = class extends be {
  ...
  Vi = class extends j {
    ...
    paint(e, r) {
      ...
      let i = e.color,
        n = [
          r.start,
          new d(r.start.x, r.end.y),
          r.end,
          new d(r.end.x, r.start.y),
          r.start,
        ]
      this.gfx.line(new F(n, r.width, i)),
        r.fill && r.fill != 'none' && this.gfx.polygon(new I(n, i))
    }
  },
  gi = class extends j {
    constructor() {
  ...
  Wi = class extends j {
    ...
    paint(e, r) {
      ...
      if (r.fill && r.fill != 'none')
        this.gfx.circle(new B(o.center, o.radius + (r.width ?? 0), i))
      else {
        let c = o.to_polyline()
    ...
    paint(e, r) {
      if (r.filled_polygons && !(this.filter_net && r.net != this.filter_net))
        for (let i of r.filled_polygons)
          (!e.name.includes(i.layer) && e.name != ':Overlay') ||
            this.gfx.polygon(new I(i.pts, e.color))
    }
  },
  yi = class extends j {
    constructor() {
    ...
    paint(e, r) {
      ...
      let o = new d(0, 0)
      if (
        (e.name == ':Pad:Holes' || e.name == ':NonPlatedHoles') &&
        r.drill != null
      )
        if (r.drill.oval) {
          ...
          case 'trapezoid':
            {
              ...
              this.gfx.polygon(new I(M, i)),
                this.gfx.line(new F([...M, M[0]], p * 2, i))
            }
            break
          case 'oval':
            {
              let p = new d(r.size.x / 2, r.size.y / 2),
                ...
                V = M.add(b)
              f.equals(V)
                ? this.gfx.circle(new B(M, m, i))
                : this.gfx.line(new F([f, V], m * 2, i))
            }
            break
          default:
        ...
        if (r.shape == 'custom' && r.primitives)
          for (let p of r.primitives) this.view_painter.paint_item(e, p)
      }
      this.gfx.state.pop()
    }
  },
    ...
    paint(e, r) {
      ...
      if (r.render_cache) {
        for (let n of r.render_cache.polygons)
          this.view_painter.paint_item(e, n)
        return
      }
      let i = new $(r.shown_text)
  ...
  Ui = class extends j {
    ...
    paint_radial(e, r) {
      ...
      this.gfx.line([r.end.add(y), r.end, r.end.add(S)], i, e.color),
        this.paint_text(u)
    }
    paint_leader(e, r) {
      let i = r.style.thickness ?? 0.2,
    ...
    paint_linear(e, r) {
      ...
      let u =
          Math.abs(r.height) -
          r.style.extension_offset +
          r.style.extension_height,
    ...
    make_text(e, r) {
      ...
      return (
        i.apply_effects(r.gr_text.effects),
  ...
  Fi = class extends j {
    ...
    paint(e, r) {
      let i = U.translation(r.at.position.x, r.at.position.y).rotate_self(
        W.deg_to_rad(r.at.rotation),
      )
      this.gfx.state.push(), this.gfx.state.multiply(i)
      for (let n of r.items()) {
        let o = this.view_painter.layers_for(n)
        ;(e.name == ':Overlay' || o.includes(e.name)) &&
          this.view_painter.paint_item(e, n)
      }
      this.gfx.state.pop()
    }
...
var x3 = class extends Ft {
  ...
  select(t) {
    G(t) && (t = this.board.find_footprint(t)),
      t instanceof xe && (t = t.bbox),
      super.select(t)
  }
  highlight_net(t) {
...
var Qi = class extends N {
  ...
  render() {
    let e = this.viewer.drawing_sheet,
      ...
      c = Object.entries(r.title_block?.comment || {}).map(([u, p]) =>
        o(`Comment ${u}`, p),
      )
    return _`
            <kc-ui-panel>
...
var x2 = class extends N {
    ...
    this.panel_body.addEventListener(Q2.select_event, (e) => {
      ...
      this.renderRoot
        ...
        ?.addEventListener('click', (e) => {
          ...
          if (this.items.some((i) => i.layer_visible))
            for (let i of r) i.visible = !1
      ...
      this.presets_menu.addEventListener('kc-ui-menu:select', (e) => {
        ...
        switch (r.name) {
          ...
          case 'front':
            for (let n of i)
              n.visible = n.name.startsWith('F.') || n.name == 'Edge.Cuts'
            break
          case 'back':
            for (let n of i)
              n.visible = n.name.startsWith('B.') || n.name == 'Edge.Cuts'
            break
          case 'copper':
            for (let n of i)
              n.visible = n.name.includes('.Cu') || n.name == 'Edge.Cuts'
            break
          case 'outer-copper':
            for (let n of i)
              n.visible =
                n.name == 'F.Cu' || n.name == 'B.Cu' || n.name == 'Edge.Cuts'
            break
          case 'inner-copper':
            for (let n of i)
              n.visible =
                (n.name.includes('.Cu') &&
                  !(n.name == 'F.Cu' || n.name == 'B.Cu')) ||
                n.name == 'Edge.Cuts'
            break
          case 'drawings':
            for (let n of i)
  ...
  update_item_states() {
    for (let e of this.items) {
      ...
      ;(e.layer_visible = r?.visible ?? !1),
        (e.layer_highlighted = r?.highlighted ?? !1)
    }
  }
  render() {
...
P([Q('kc-ui-panel-body', !0)], x2.prototype, 'panel_body', 2),
  P([Q('#presets', !0)], x2.prototype, 'presets_menu', 2)
  ...
  render() {
    let e = l(
      ...
      i = l(
        (o) =>
          o
            ? _`<kc-ui-icon>check</kc-ui-icon>`
            : _`<kc-ui-icon>close</kc-ui-icon>`,
        'checkbox',
      ),
      n
...
var Q3 = class extends Ke {
    ...
    circle(e, r, i) {
      ...
      let o = n.color.to_css(),
        c = new Path2D()
      c.arc(n.center.x, n.center.y, n.radius, 0, Math.PI * 2),
        this.#t.commands.push(new Qt(c, o, null, 0))
    }
    line(e, r, i) {
      let n = super.prep_line(e, r, i)
      if (!n.color || n.color.is_transparent_black) return
      ...
      for (let p of n.points)
        u ? c.lineTo(p.x, p.y) : (c.moveTo(p.x, p.y), (u = !0))
    ...
    polygon(e, r) {
      ...
      let n = i.color.to_css(),
        o = new Path2D(),
        c = !1
      for (let u of i.points)
        c ? o.lineTo(u.x, u.y) : (o.moveTo(u.x, u.y), (c = !0))
  ...
  Ki = class extends He {
    ...
    push_path(e, r, i, n) {
      ...
      o &&
      (o.path_count < 20, o.fill == r && o.stroke == i && o.stroke_width == n)
...
var v3 = class extends Ee {
  ...
  K = class extends be {
    ...
    determine_fill(e, r) {
      ...
      if (i == 'none' || (i == 'background' && e.name != ':Symbol:Background'))
        return null
      let n
      switch (i) {
        case 'background':
...
var w2 = class extends K {
    ...
    paint(e, r) {
      ...
      i.apply_at(r.at),
        ...
        r.at.rotation == 0 || r.at.rotation == 180
          ...
          : (r.at.rotation == 90 || r.at.rotation == 270) &&
            (i.text_angle.degrees = 90)
    ...
    get_schematic_text_offset(e, r) {
      let i = Math.round(
        this.get_text_offset(r) + r.get_effective_text_thickness(),
      )
  ...
  Y3 = class extends w2 {
    ...
    get_schematic_text_offset(e, r) {
      let i = e,
        ...
        c = n * 0.0715
      switch (
        (['input', 'bidirectional', 'tri_state'].includes(i.shape) &&
          (o += n * 0.75),
        (o = Math.round(o)),
        (c = Math.round(c)),
        e.at.rotation)
...
var H3 = class s extends K {
  ...
  paint(e, r) {
    ...
    s.apply_symbol_transformations(i, n),
      ...
      (e.name == ':Symbol:Pin' || e.name == ':Interactive') &&
        this.draw_pin_shape(this.gfx, i),
  ...
  static apply_symbol_transformations(e, r) {
    ...
    r.mirror_x && this.mirror_vertically(e, new d(0, 0)),
      r.mirror_y && this.mirror_horizontally(e, new d(0, 0))
  ...
  static mirror_horizontally(e, r) {
    ;(e.position.x -= r.x),
      ...
      e.orientation == 'right'
        ? (e.orientation = 'left')
        : e.orientation == 'left' && (e.orientation = 'right')
  }
  static mirror_vertically(e, r) {
    ;(e.position.y -= r.y),
      ...
      e.orientation == 'up'
        ? (e.orientation = 'down')
        : e.orientation == 'down' && (e.orientation = 'up')
  }
  draw_pin_shape(e, r) {
    ...
    draw(s, t, e, r, i, n) {
      ...
      let p = l(() => {
        ...
        m = l(() => {
          n.y
            ? s.line([
                i.add(new d(0, n.y).multiply(c)),
                i.add(new d(-1, n.y).multiply(c)),
                i,
              ])
            : s.line([
                i.add(new d(n.x, 0).multiply(c)),
                i.add(new d(n.x, -1).multiply(c)),
                i,
              ])
        }, 'low_in_tri')
      switch (e) {
...
var E3 = class extends K {
    ...
    paint(e, r, i = 1) {
      if (
        ![':Symbol:Background', ':Symbol:Foreground', ':Interactive'].includes(
          e.name,
        )
      )
        return
    ...
    #e(e, r, i = 1) {
      for (let n of r)
        if (!(n.style > 0 && i != n.style))
          for (let o of n.drawings) this.view_painter.paint_item(e, o)
    }
  },
  J3 = class extends K {
    constructor() {
    ...
    paint(e, r) {
      ...
      ;(this.view_painter.current_symbol = r),
        ...
        this.gfx.state.push(),
        (this.gfx.state.matrix = U.translation(
          r.at.position.x,
          r.at.position.y,
        )),
      ...
      if (r.dnp && e.name == ':Marks') {
        ...
        this.gfx.line([o.top_left, o.bottom_right], c, u),
          this.gfx.line([o.bottom_left, o.top_right], c, u)
      }
...
var Gi = class extends K {
    ...
    #e(e, r, i) {
      ...
      !n ||
        !o ||
        this.gfx.line(
          new F(i, r.stroke?.width || this.gfx.state.stroke_width, o),
        )
    }
    #t(e, r, i) {
  ...
  ki = class extends K {
    ...
    paint(e, r) {
      this.gfx.line(
        new F(
          [r.at.position, r.at.position.add(r.size)],
          A.wire_width,
          this.theme.wire,
        ),
      )
  ...
  Ai = class extends K {
    ...
    #e(e, r) {
      ...
      !i ||
        !n ||
        this.gfx.arc(
          new Ye(r.center, r.radius, new W(0), new W(Math.PI * 2), i, n),
        )
    }
    #t(e, r) {
      let i = this.determine_fill(e, r)
  ...
  Ci = class extends K {
    ...
    #e(e, r, i) {
      ...
      !n ||
        !o ||
        this.gfx.arc(
          new Ye(i.center, i.radius, i.start_angle, i.end_angle, n, o),
        )
    }
    #t(e, r, i) {
      let n = this.determine_fill(e, r)
  ...
  ji = class extends K {
    ...
    paint(e, r) {
      ...
      ;(b = u.inverse().transform(b)),
        (b = b.add(m.parent.position)),
        (m.text_pos = b)
      ...
      ;(m.attributes.angle = M),
        ...
        (m.attributes.stroke_width = m.get_effective_text_thickness(
          A.line_width * 1e4,
        )),
  ...
  zi = class extends K {
    ...
    paint_debug(e) {
      this.gfx.line(F.from_BBox(e.scale(1 / 1e4), 0.127, new h(0, 0, 1, 1))),
        this.gfx.circle(
          new B(e.center.multiply(1 / 1e4), 0.2, new h(0, 1, 0, 1)),
        )
    }
  },
  qi = class extends K {
    ...
    paint(e, r) {
      ...
      if (
        (e.name == ':Interactive' &&
          this.gfx.polygon(I.from_BBox(o.grow(3), n)),
        e.name == ':Symbol:Background' && this.gfx.polygon(I.from_BBox(o, n)),
        e.name == ':Symbol:Foreground' &&
          this.gfx.line(F.from_BBox(o, this.gfx.state.stroke_width, i)),
        e.name == ':Symbol:Field')
      )
...
var I3 = class extends Ft {
  ...
  create_renderer(t) {
    let e = new Q3(t)
    return (
      (e.state.fill = this.theme.note),
      (e.state.stroke = this.theme.note),
      (e.state.stroke_width = 0.1524),
      e
    )
  }
  async load(t) {
  ...
  select(t) {
    if (
      (G(t) &&
        (t = this.schematic.find_symbol(t) ?? this.schematic.find_sheet(t)),
...
var ts = class extends N {
  ...
  render() {
    let e = this.viewer.drawing_sheet,
      ...
      o = Object.entries(r.title_block?.comment || {}).map(([c, u]) =>
        n(`Comment ${c}`, u),
      )
    return _`
            <kc-ui-panel>
  ...
  render() {
    ...
    if (!o) n = e('No item selected')
      ...
      let c = o.lib_symbol,
        ...
        p = pe(o.unit_pins, (m) => m.number).map((m) =>
          r(m.number, m.definition.name.text),
        )
      n = _`
                ${e('Basic properties')}
                ${r('X', o.at.position.x.toFixed(4), 'mm')}
...
var _e = class extends N {
  ...
  async #s() {
    ...
    for (let i of this.querySelectorAll('kicanvas-source'))
      i.src && e.push(i.src)
    if (e.length == 0) {
